...
import { useAppDispatch, useAppSelector, useAppSelector2 } from '../../store'
...
const User: FC = () => {
	...
	const user = useAppSelector2(selectUser)
	const status = useAppSelector2(selectUserFetchStatus)
